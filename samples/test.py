...
def get_sample_trending_links_data():
    ...
    trending_links_filename = "mastodon/trending_links_sample_file.json"
...
def get_sample_trending_statuses_data():
    ...
    trending_statuses_filename = "mastodon/trending_statuses_sample_file.json"
...
def get_sample_timeline_data():
    ...
    timeline_filename = "mastodon/timeline_sample_file.json"
...
def get_sample_trends_data():
    ...
    trends_filename = "mastodon/trends_sample_file.json"
...
def get_sample_tags_data():
    ...
    tags_filename = "mastodon/tags_sample_file.json"
